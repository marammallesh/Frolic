package frolic_prod.wallet.pages;
...
public class FrolicWalletPage extends BaseFrolicAutomationPage {
	...
	//@FindBy(id = "live.frolic.app:id/iv_wallet")
	@FindBy(xpath = "//android.widget.TextView[@text = 'Wallet']")
	private WebElement btnWallet;

	@FindBy(id = "live.frolic.app:id/btn_transaction_history")
	...
	@FindBy(id = "live.frolic.app:id/btn_help_support")
	private WebElement btnHelp;

	@FindBy(id = "live.frolic.app:id/btn_learn_more")
	...
	@FindBy(id = "live.frolic.app:id/tv_bonus_cash")
	...
	@FindBy(id = "live.frolic.app:id/tv_error")
	private WebElement txtErrorMsg;

	@FindBy(id = "live.frolic.app:id/tv_view_all")
	...
	@FindBy(id = "live.frolic.app:id/tv_coupon_apply")
	private WebElement btnApplyCoupon;

	@FindBy(id = "live.frolic.app:id/btn_back")
	private WebElement btnBack;

	@FindBy(id = "live.frolic.app:id/et_upi_address")
	private WebElement txtUpiId;

	@FindBy(id = "live.frolic.app:id/tv_info_text")
	private WebElement txtUpiError;

	@FindBy(id = "live.frolic.app:id/btn_continue")
	...
	@FindBy(id = "live.frolic.app:id/chosen_bank_name")
	...
	@FindBy(id = "live.frolic.app:id/tv_ammount")
	...
	@FindBy(id = "live.frolic.app:id/iv_share")
	...
	@FindBy(id = "live.frolic.app:id/error_text")
	private WebElement txtNoScratchCards;

	@FindBy(id = "live.frolic.app:id/tv_available_coupon")
