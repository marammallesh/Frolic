package frolic_prod.login.pages;
...
public class FrolicUserLoginPage extends BaseFrolicAutomationPage {
	...
	@FindBy(id = "live.frolic.app:id/et_mobile_no")
	...
	@FindBy(id = "live.frolic.app:id/et_username")
	private WebElement txtUserName;

	@FindBy(id = "live.frolic.app:id/tv_error")
	private WebElement txtName;

	@FindBy(id = "live.frolic.app:id/tv_suggestions")
	private WebElement txtSuggestions;

	@FindBy(id = "live.frolic.app:id/et_referral")
	private WebElement txtReferral;

	@FindBy(id = "live.frolic.app:id/tv_error_referral")
	...
	@FindBy(id = "live.frolic.app:id/simpleDraweeView3")
	private WebElement btnCloseIcon;

	@FindBy(id = "live.frolic.app:id/feed")
