...
public class FrolicRaiseTicketPage extends BaseFrolicAutomationPage {
	...
	@FindBy(id = "live.frolic.app.debug:id/iv_thumbnail")
	private WebElement imgSelectFile;

	@FindBy(id = "live.frolic.app.debug:id/btn_close_preview")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_ticket_number")
	private WebElement txtTicketId;

	@FindBy(id = "live.frolic.app.debug:id/tv_description")
	...
	@FindBy(id = "live.frolic.app.debug:id/freshchat_conv_detail_reply_text")
	...
	@FindBy(id = "live.frolic.app.debug:id/freshchat_conv_detail_attach_image")
