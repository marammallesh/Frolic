package live.frolic.livematches.pages;
...
public class LiveMatchesPage extends BaseFrolicAutomationPage {
    ...
    @FindBy(id = "live.frolic.app.debug:id/riv_title")
    private WebElement txtLiveMatches;

   /* @FindBy(id = "live.frolic.app.debug:id/description")
    private WebElement txtLiveMatchesDescription;*/
    
    @FindBy(id = "//android.widget.TextView[@text = 'Recommended Games']")
    private WebElement txtLiveMatchesDescription;
    
    @FindBy(id = "live.frolic.app.debug:id/btnAction")
    private WebElement btnViewAllMatchesButton;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/semiBoldTextView5']")
    private WebElement matchLiveContestText;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/tv_selected_game']")
    private WebElement btnSelectGameDropDown;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/tv_title']")
    private WebElement selectGameText;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/et_search']")
    private WebElement btnSearchField;

    @FindBy(id = "live.frolic.app.debug:id/img_banner")
    private WebElement imgMonsterStriker;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/iv_refresh']")
    private WebElement clickRefreshField;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/entry_layout']")
    private WebElement clickEntryPoint;
    @FindBy(id = "live.frolic.app.debug:id/error_text_title")
