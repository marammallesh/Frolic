package live.frolic.settings.pages;
...
public class FrolicSettingsPage extends BaseFrolicAutomationPage {
	...
	@FindBy(id = "live.frolic.app.debug:id/sw_privacy")
	private WebElement btnPrivateToggle;

	@FindBy(id = "live.frolic.app.debug:id/sw_push_notifications")
	private WebElement btnPushToggle;

	@FindBy(id = "live.frolic.app.debug:id/img_edit")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_contact_us")
	private WebElement lblContactUs;

	@FindBy(id = "live.frolic.app.debug:id/btn_share")
	private WebElement btnShare;

	@FindBy(id = "live.frolic.app.debug:id/tv_delete_account")
	private WebElement btnDelete;

	@FindBy(id = "live.frolic.app.debug:id/btn_remove")
	private WebElement btnConfirmDelete;

	@FindBy(id = "live.frolic.app.debug:id/btn_done")
	private WebElement icnDone;

	@FindBy(id = "live.frolic.app.debug:id/tv_privacy")
	private WebElement lblPrivateAccount;

	@FindBy(id = "live.frolic.app.debug:id/tv_push_notifications")
	private WebElement lblPushNotifications;

	@FindBy(id = "live.frolic.app.debug:id/tv_daily_limit")
	private WebElement lblDailyLimit;

	@FindBy(id = "live.frolic.app.debug:id/tv_blocked_users")
	private WebElement lblBlockedUsers;

	@FindBy(id = "live.frolic.app.debug:id/tv_title")
	private WebElement txtSetLimit;

	@FindBy(id = "live.frolic.app.debug:id/btn_ok")
	private WebElement btnOk;

	@FindBy(id = "live.frolic.app.debug:id/tv_share_profile")
	...
	public void SetLimit() {
		...
		WebElement slider = driver.findElement(By.id("live.frolic.app.debug:id/seek_bar"));
