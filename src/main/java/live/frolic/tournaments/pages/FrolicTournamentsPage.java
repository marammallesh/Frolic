package live.frolic.tournaments.pages;
...
public class FrolicTournamentsPage extends BaseFrolicAutomationPage {
	...
	@FindBy(id = "live.frolic.app.debug:id/tvViewAll") //// android.widget.TextView[@text = 'View all'] changed in
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_history")
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_join")
	private WebElement btnResult;

	@FindBy(id = "live.frolic.app.debug:id/tv_title")
	private WebElement txtResultScreen;

	@FindBy(id = "live.frolic.app.debug:id/iv_more")
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_info")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_game_mode_title")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_amnt_title")
	private WebElement txtprizepool;

	@FindBy(id = "live.frolic.app.debug:id/tv_fee_title")
