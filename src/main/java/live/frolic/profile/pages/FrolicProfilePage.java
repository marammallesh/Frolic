package live.frolic.profile.pages;
...
public class FrolicProfilePage extends BaseFrolicAutomationPage {
    ...
    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/iv_avatar']")
    ...
    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/tv_user_name_layout']")
    private WebElement verifyUserName;

    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/tv_phone_user_id']")
    ...
    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/top_title']")
    ...
    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/view_all']")
    private WebElement clickViewAllBtn;
    @FindBy(xpath = "//*[@resource-id='live.frolic.app.debug:id/edit_save_changes']")
