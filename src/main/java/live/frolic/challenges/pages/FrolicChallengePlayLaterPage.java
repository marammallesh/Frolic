package live.frolic.challenges.pages;
...
public class FrolicChallengePlayLaterPage extends BaseFrolicAutomationPage {
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_view_all")
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_challenge_user")
	...
	@FindBy(id = "live.frolic.app.debug:id/rb_digital_currency")
	...
	@FindBy(id = "live.frolic.app.debug:id/rb_currency")
	private WebElement btnCash;

	@FindBy(id = "live.frolic.app.debug:id/btn_schedule_match")
	private WebElement btnRemind;

	@FindBy(id = "live.frolic.app.debug:id/label")
