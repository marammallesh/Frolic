package live.frolic.achievement.pages;
...
public class FrolicAchievementPage extends BaseFrolicAutomationPage {
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_rewards")
	private WebElement btnRewards;

	@FindBy(xpath = "//android.widget.TextView[@text = 'Raise Ticket']")
	private WebElement btnRaiseTicket;

	@FindBy(id = "live.frolic.app.debug:id/ed_email")
	private WebElement txtEmailId;

	@FindBy(id = "live.frolic.app.debug:id/ed_comment")
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_add_attachment")
	...
	@FindBy(id = "live.frolic.app.debug:id/btn_create_ticket")
	...
	@FindBy(id = "live.frolic.app.debug:id/swipe_layout")
	...
	@FindBy(id = "live.frolic.app.debug:id/iv_icon_chat")
	...
	@FindBy(id = "live.frolic.app.debug:id/freshchat_conv_detail_send_reply_button")
	...
	@FindBy(id = "live.frolic.app.debug:id/raise_ticket")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_chat")
	private WebElement btnBonusCashChatWithUs;

	@FindBy(xpath = "//android.widget.EditText[@text = 'Type a message']")
	private WebElement txtBonusCashChatMessage;

	@FindBy(id = "live.frolic.app.debug:id/tv_journey")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_learn_more")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_earn")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_weekly")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_claim")
	private WebElement btnClaimReward;

	@FindBy(id = "live.frolic.app.debug:id/tv_claim")
	private WebElement btnParticipate;

	@FindBy(id = "live.frolic.app.debug:id/tv_history")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_subject")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_app_name")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_recommended")
	...
	@FindBy(id = "live.frolic.app.debug:id/tv_dismiss")
